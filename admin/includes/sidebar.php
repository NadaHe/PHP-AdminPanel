...
<aside class="sidenav sidebarcolor shadow navbar navbar-vertical navbar-expand-xs border-0 fixed-start ms-3 bg-grey" id="sidenav-main">
    <div class="sidenav-header text-center">
        ...
        <a class="navbar-brand m-0" href="../index.php">
            ...
            <span class="ms-1 h3 fw-bold text-white h2">إلكتريتو</span>
        </a>
    </div>
        ...
        <ul class="navbar-nav">
            <li class="nav-item">
                <a class="nav-link text-white  <?= $page== "index.php"?'active':'' ?>"   href="index.php">
                    <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
                        <i class="material-icons opacity-10 text-white ms-1">dashboard</i>
                    </div>
            ...
            <li class="nav-item">
                <a class="nav-link text-white <?= $page== "add-category.php"?'active':'' ?>"  href="add-category.php">
                    <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
                        <i class="material-icons opacity-10 text-white ms-1">add</i>
                    </div>
                    <span class="nav-link-text ms-1 text-white">add category</span>
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link text-white <?= $page == "category.php"?'active':'' ?>"    href="category.php">
                    <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
                        <i class="material-icons opacity-10 text-white ms-1">table_view</i>
                    </div>
                    <span class="nav-link-text ms-1 text-white">All categories</span>
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link text-white <?= $page == "add-product.php"?'active':'' ?>"    href="add-product.php">
                    ...
                    <span class="nav-link-text ms-1 text-white">add product</span>
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link text-white <?= $page== "products.php"?'active':'' ?>"  href="products.php">
                    ...
                    <span class="nav-link-text ms-1 text-white">All products</span>
                </a>
            </li>
            ...
            <li class="nav-item">
                <a class="nav-link text-white <?= $page== "admins.php"?'active':'' ?>"  href="admins.php">
                    ...
                    <span class="nav-link-text ms-1 text-white">Admins</span>
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link text-white <?= $page== "contact-us.php"?'active':'' ?>"  href="contact-us.php">
                    ...
                    <span class="nav-link-text ms-1 text-white">Messages</span>
                </a>
            </li>
        </ul>
    </div>
    <div class="sidenav-footer position-absolute w-100 bottom-0 ">
        <div class="mx-3">
            <a class="btn btn-warning mt-4 w-100 fw-bold h6" 
