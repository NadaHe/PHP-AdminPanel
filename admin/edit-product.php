            ...
            ?>
                    <div class="card">
                        <div class="card-header top">
                            <h4>Edit Product
                                <a href="products.php" class="btn btn-warning float-start">Back</a>
                            </h4>
                        </div>
                        <div class="card-body">
                            <form action="code.php" method="POST" enctype="multipart/form-data">
                                <div class="row">
                                    <div class="col-md-12">
                                        <label for="" class="fw-bold h5">Select Category</label>
                                    ...
                                    <div class="col-md-12">
                                        <label for="" class="fw-bold h5">Small Description</label>
                                    ...
                                    <div class="col-md-6">
                                        <label for=""class="fw-bold h5">Original price</label>
                                    ...
                                    <div class="col-md-6">
                                        <label for="" class="fw-bold h5">Selling price</label>
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <label for="" class="fw-bold h5">Current Image</label>
                                    ...
                                    <div class="col-md-12">
                                        <button type="submit" class="btn btn-warning mt-3 fw-bold h6" name="update_product_btn">تحديث</button>
                                    </div>
                                </div>
                            </form>
                        </div>
