...
if (isset($_POST['add_category_btn'])) {
    ...
    if ($name != "" && $slug != "" && $small_description != "" && $description != "" && $original_price != "" && $selling_price != "" && $qty != "" && $meta_title != "" && $meta_description != "" && $meta_keywords != "" && $status != "" && $trending != "" && $image != "") {
...
else if(isset($_POST['update_order_btn']))
{
    ...
    $updateOrder_query="UPDATE orders set order_status='$order_status' where tracking_no='$track_no'";
