  ...
  <div class="container">
    ...
    <div class="row">
      <div class="col-md-3">
        ...
        <a href="contact-us.php" class="text-white mb-2 hover"><i class="fa fa-angle-left"></i>اتصل بنا</a> <br>
      ...
      <div class="col-md-3">
        ...
        <a href="mailto:xyz@gmail.com" class="text-white"><i class="fa fa-envelope"></i> xyz@gmail.com</a><br>
        <a href="#" class="text-white"><i class="fa-brands fa-facebook"></i> صفحتنا على الفيسبوك</a><br>
      </div>
      <div class="col-md-6">
